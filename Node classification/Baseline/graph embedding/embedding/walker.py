...
class RandomWalker:
    ...
    def get_alias_edge(self, t, v):
        ...
        if norm_const != 0:
            ...
            normalized_probs = [float(u_prob) / sum(list(map(abs, unnormalized_probs))) for u_prob in
                                unnormalized_probs]
    ...
    def preprocess_transition_probs(self):
        ...
        for node in G.nodes():
            ...
            if norm_const != 0:
                ...
                normalized_probs = [float(u_prob) / sum(list(map(abs,unnormalized_probs))) for u_prob in unnormalized_probs]
